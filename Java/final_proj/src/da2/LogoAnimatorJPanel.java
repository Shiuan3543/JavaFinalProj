...
public class LogoAnimatorJPanel extends JPanel {
	private final static String IMAGE_NAME = "Items_border_"; // base image name
	protected ImageIcon[] images; // array of images
	private final int TOTAL_IMAGES = 9; // number of images
	...
	public LogoAnimatorJPanel() {
		...
		for (int count = 0; count < images.length; count++)
			images[count] = new ImageIcon(getClass().getResource("/gif/" + IMAGE_NAME + count + ".png"));
